...
function detecterSecteurSousSecteur(signal = {}) {
  const secteurs = window.FLAIR_METIER_SECTEURS || {};
  if (typeof secteurs.detecterSecteurSousSecteur !== 'function') {
    console.error('FLAIR_METIER_SECTEURS indisponible : classification sectorielle non chargée.');
  ...
  return secteurs.detecterSecteurSousSecteur(signal, {
    normaliserTexte: normaliserTexteSimple,
    texteCompletSignal: texteCompletSignalFlair,
    motClePresent: motCleFlairPresent
  });
}
