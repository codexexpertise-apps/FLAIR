...
(function () {
  ...
  function getLexiqueApiFlair() {
    return window.FLAIR_METIER_LEXIQUE || {};
  }

  function normaliserTexteFlair(value) {
    const fn = getLexiqueApiFlair().normaliserTexteHistoriqueSource;
  ...
  function escapeRegexFlair(value) {
    const fn = getLexiqueApiFlair().escapeRegexFlair;
    if (typeof fn === "function") return fn(value);
