...
(function () {
  ...
  const FLAIR_SECTEURS_SOUS_SECTEURS_CIBLES = {
    ...
    packaging: [
      ...
      "Impression packaging / hélio / flexo",
      "Complexage / finition / vernis / encres",
      "Contrôle impression"
    ],
  ...
  const FLAIR_FAMILLES_PROJETS = {
    ...
    process: {
      ...
      keywords: [
        ...
        "equipements de pesage",
        "contrôle qualité en ligne",
        "controle qualite en ligne",
        "systèmes de contrôle qualité en ligne",
        "systemes de controle qualite en ligne",
        "convoyage",
        "convoyeur",
        "accumulation",
        "palettisation",
  ...
  ,
    ...
    ,
    {
      ...
      sous_profils_metiers: {
        packaging: ["impression_packaging", "helio", "flexo", "complexage", "finition", "vernis", "encres", "controle_impression"],
        vision: ["controle_aspect", "controle_etiquette", "lecture_code"],
        process: ["convoyage", "automatisme"]
      },
      intensite_metier: { packaging: 0.9, vision: 0.62, process: 0.55 },
      secteur: ["packaging"],
      sources: ["presse", "google_alerts", "rss", "linkedin", "manuel"],
      keywords: [
        "impression packaging", "imprimerie packaging", "impression emballage", "impression d'emballages", "impression d’emballages",
        "impression hélio", "impression helio", "héliogravure", "heliogravure", "rotogravure",
        "impression flexo", "flexographie", "flexo", "ligne d'impression", "ligne d’impression", "machine d'impression", "machine d’impression",
        "complexage", "complexe souple", "films imprimés", "films imprimes", "vernis", "encres", "encres alimentaires",
        "finition", "contrôle impression", "controle impression", "défaut d'impression", "defaut d'impression", "repérage couleur", "reperage couleur"
      ],
      score_bonus: 22,
      chaleur: "tiede",
      type_signal: "investissement",
    ...
    },
    {
      ...
      sous_profils_metiers: {
        detection: ["detecteur_metaux", "rayon_x"],
        pesage: ["balance", "tri_ponderal", "etiquetage"],
        packaging: ["films", "etiquettes", "carton", "impression_packaging", "controle_impression"],
        vision: ["controle_aspect", "controle_etiquette", "lecture_code"],
        process: ["convoyage", "automatisme", "manutention"]
      },
      intensite_metier: { detection: 0.58, pesage: 0.55, packaging: 0.68, vision: 0.58, process: 0.62 },
      secteur: ["industrie"],
      sources: ["presse", "google_alerts", "rss", "linkedin", "manuel"],
      keywords: [
        "rachat", "rachète", "rachete", "a racheté", "a rachete", "acquisition", "acquiert", "reprend", "reprise",
        "fusion", "fusionne", "rapprochement", "regroupement", "regroupe", "regroupement de sites",
        "prise de participation", "changement d'actionnaire", "changement d’actionnaire", "nouvel actionnaire", "nouveaux actionnaires",
        "entrée au capital", "entree au capital", "fonds d'investissement", "fonds d’investissement", "cession", "transmission",
        "nouvelle direction", "nouveau dirigeant", "nouvelle gouvernance"
      ],
      score_bonus: 18,
      chaleur: "tiede",
      type_signal: "changement_capitalistique",
      raison: "Changement capitalistique ou regroupement : période où les budgets, sites, fournisseurs et standards industriels peuvent être remis à plat.",
      opportunite: "Qualifier les conséquences industrielles du rachat ou regroupement : investissements, harmonisation des équipements, nouveaux standards qualité, packaging ou process.",
      action: "Identifier direction générale, direction industrielle ou achats pour comprendre les priorités post-rachat et les éventuels projets à venir."
    }
