...
async function analyserArticleImporte() {
  ...
  if (window.FLAIR_SIGNAL_VALIDATOR?.validerSignal) {
    signalImporte = window.FLAIR_SIGNAL_VALIDATOR.validerSignal(signalImporte, texte, { mode: 'manuel_payload' }).signal || signalImporte;
  }
  ...
  if (window.FLAIR_SIGNAL_VALIDATOR?.validerSignal) {
    signalInsere = window.FLAIR_SIGNAL_VALIDATOR.validerSignal(signalInsere, texte, { mode: 'manuel_distribution' }).signal || signalInsere;
  }
