...
async function analyserArticleImporte() {
  ...
  let signalImporte;
  try {
    signalImporte = extraireSignalDepuisArticle(texteAnalyse);
  ...
  const payload = {
    ...
    source_confiance: signalImporte.source_confiance || (metaImport.origine === 'terrain' ? 'elevee_terrain_direct' : 'standard_web_ia'),
  ...
  if (signalImporte.contact_terrain) payload.contact_terrain = signalImporte.contact_terrain;
  if (signalImporte.fonction_contact_terrain) payload.fonction_contact_terrain = signalImporte.fonction_contact_terrain;
  if (signalImporte.localisation_connue) payload.localisation_connue = signalImporte.localisation_connue;
