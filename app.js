  ...
  return `
    <tr>
      ...
      <td class="opportunites-coords-cell">
        <small><b>🌐</b> ${managerEscape(signalSiteWeb(s) || '—')}</small><br>
        <small><b>☎</b> ${managerEscape(signalTelephoneStandard(s) || '—')}</small><br>
        <small><b>✉</b> ${managerEscape(signalEmailGenerique(s) || '—')}</small>
      </td>
      <td>${sourceCell}</td>
    </tr>
  `;
