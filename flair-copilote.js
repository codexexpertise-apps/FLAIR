...
(function () {
  ...
  function detecterContexte(signal = {}, resultat = {}, timing = {}) {
    ...
    const projetLogistique = has("logistique", "entrepot", "plateforme", "plate-forme", "flux");
    const qualite = has("qualite", "rappel", "contamination", "corps etranger", "incident", "inspection");
  ...
  function action(signal = {}, timing = {}, interlocuteurs = "", defaut = "") {
    ...
    if (contexte.projetLogistique) pool = PHRASES.action.logistique;
